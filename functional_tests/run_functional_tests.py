...
def run():
    ...
    # for test_module in [func_test_successful_job_run, func_test_job_cache, func_test_parallel_job_submission, func_test_failing_job]:
    for test_module in [func_test_failing_job]:
